 ...
 * UploadHandleServlet
 */
@WebServlet(value = "/uploadHandleServlet")
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            if(!ServletFileUpload.isMultipartContent(request)){
                ...
                out.print("Enctype multipart/form-data: error, not included in the form");
                //按照传统方式获取数据
                return;
            }
            ...
            for(FileItem item : list){
                ...
                if(item.isFormField()){
                    ...
                    System.out.println("保存路径为:"+realSavePath);
                    //创建一个文件输出流
                    ...
                    //删除处理文件上传时生成的临时文件
                    //item.delete();
                    message = "文件上传成功！"+"保存路径为:"+realSavePath;
                }
            }
